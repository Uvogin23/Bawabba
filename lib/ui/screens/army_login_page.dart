...
class LoginScreenArmy extends StatefulWidget {
  ...
  @override
  State<LoginScreenArmy> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<LoginScreenArmy> {
  ...
  Widget build(BuildContext context) {
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(children: [
                                      ...
                                      const Text(
                                        ' وزارة الدفــــاع الوطنـــــــي  ',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                                            color: Color.fromRGBO(
                                                255, 255, 255, 1),
    ...
    /*Scaffold(
      backgroundColor: const Color.fromARGB(255, 227, 228, 225),
      body: Padding(
