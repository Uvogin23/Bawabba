...
class SimpleLineChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final touristsData = [50, 40, 60, 55, 70];
    final diplomatsData = [30, 25, 35, 40, 45];
    final algeriansData = [70, 60, 80, 75, 90];
    ...
    return LineChart(
      LineChartData(
        ...
        lineBarsData: [
          _buildLineChartBarData(touristsData, Colors.blue),
          _buildLineChartBarData(diplomatsData, Colors.green),
          _buildLineChartBarData(algeriansData, Colors.red),
        ],
