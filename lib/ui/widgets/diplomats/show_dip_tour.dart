...
class ViewDipTour extends StatefulWidget {
  final int id;
  const ViewDipTour({
    Key? key,
    required this.id,
  ...
  @override
  State<ViewDipTour> createState() => _ViewDipTour();
}

class _ViewDipTour extends State<ViewDipTour> {
                ...
                FutureBuilder<List<Tourist>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return const Center(child: Text("لا يوجد سياح مرافقون"));
                    } else {
                        ...
                        child: DataTable(
                          ...
                          rows: tourists.map((tourist) {
                            return DataRow(
                              ...
                              cells: [
                                DataCell(tourist.depMsgReff == null
                                    ? IconButton(
                                        icon: Icon(
                                          selectedTouristIds
                                                  .contains(tourist.id)
