                      ...
                      return DataRow(
                        ...
                        cells: [
                          DataCell(
                            IconButton(
                              icon: Icon(
                                selectedTouristIds.contains(diplomat.id)
                                    ? Icons.check_box
                                    : Icons.check_box_outline_blank,
                                color: selectedTouristIds.contains(diplomat.id)
                              ...
                              onPressed: () {
                                setState(() {
                                  if (selectedTouristIds
                                    ...
                                    selectedTouristIds.remove(diplomat.id);
                                  } else {
                                    // Select the tourist
                                    selectedTouristIds.add(diplomat.id);
                                  }
                                });
                                /*for (int i = 0;
