...
Future<List<Diplomat>> fetchAllDiplomat() async {
  final response = await http.get(Uri.parse('${Config.baseUrl}/api/diplomats'));
...
class DiplomatHistoryTable2 extends StatefulWidget {
  const DiplomatHistoryTable2({Key? key}) : super(key: key);

  @override
  State<DiplomatHistoryTable2> createState() => _DiplomatHistoryTable2();
}

class _DiplomatHistoryTable2 extends State<DiplomatHistoryTable2> {
  ...
  void initState() {
    ...
    super.initState();
    diplomatsFuture = fetchAllDiplomat();
  }
