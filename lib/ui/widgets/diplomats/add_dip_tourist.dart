...
class _AddDipTourist extends State<AddDipTourist> {
  ...
  Future<void> _addtourist() async {
    ...
    final url =
        Uri.parse('${Config.baseUrl}/api/tourists/AddTD'); // Your API endpoint
    try {
      ...
      if (response.statusCode == 201) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(' خلل أثناء إضافة السائح ${response.body}')),
        );
      }
    } catch (e) {
      setState(() {});
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _buildTextField(
                                          _firstNameController, "الإسم"),
                                      _buildTextField(
                                          _lastNameController, "اللقب"),
                                      _buildDatePickerField(
                                          "تاريخ الميلاد", _dateOfBirth,
                                          (date) {
                                        setState(() {
                                          _dateOfBirth = date;
                                        });
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _buildTextField(_passportNumberController,
                                          "رقم جواز السفر"),
                                      _buildDatePickerField(
                                          "تاريخ الإنتهاء", _passportExpiry,
                                          (date) {
                                        setState(() {
                                          _passportExpiry = date;
                                        });
                                      },
                                          rangeStart: DateTime.now().subtract(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _buildTextField(
                                          _departureFlightInfoController,
                                          "معلومات المغادرة"),
                                      _buildTextField(
                                          _msgRefController, "المرجع"),
                                      const SizedBox(
                                        width: 15,
                                      ),
                                    ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      _buildTextField(
                                          _receivingAgencyController,
                                          "الوكالة السياحية"),
                                      _buildTextField(
                                          _circuitController, "المسار"),
                                      _buildTextField(_touristicGuideController,
                                          "المرشد السياحي"),
                                      const SizedBox(
                                        width: 15,
                                      ),
