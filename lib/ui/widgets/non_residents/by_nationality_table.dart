...
void showNonResidentsByNationality(BuildContext context) {
  Future<List<Map<String, dynamic>>> fetchNonResidentsByNationality() async {
    final url = Uri.parse('${Config.baseUrl}/api/non_residents/counts');
      ...
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          ...
          child: FutureBuilder<List<Map<String, dynamic>>>(
            future:
                fetchNonResidentsByNationality(), // Your data fetching function
