...
Future<CardStatistics> fetchStatistics() async {
  final response =
      await http.get(Uri.parse('${Config.baseUrl}/api/stats/diplomats'));
...
class DashboardCardDiplomat extends StatelessWidget {
  const DashboardCardDiplomat({
    super.key,
  });
