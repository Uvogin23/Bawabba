...
void showCitizensByMonth(BuildContext context, int year) {
  Future<Map<String, dynamic>> fetchNonResidentsData(int year) async {
    final url =
        Uri.parse('${Config.baseUrl}/api/citizens/monthly-counts?year=$year');
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text(
          " عدد حركات الخروج عبر الحدود البرية حسب الشهر من سنة $year",
        ...
        content: SingleChildScrollView(
          ...
          child: FutureBuilder<Map<String, dynamic>>(
            future: fetchNonResidentsData(year),
