...
Future<List<Citizen>> fetchAllcitizens() async {
  final response = await http.get(Uri.parse('${Config.baseUrl}/api/citizens'));
...
class CHistoryTable2 extends StatefulWidget {
  const CHistoryTable2({Key? key}) : super(key: key);

  @override
  State<CHistoryTable2> createState() => _CHistoryTable2();
}

class _CHistoryTable2 extends State<CHistoryTable2> {
  late Future<List<Citizen>> citizenFuture;
  ...
  void initState() {
    ...
    super.initState();
    citizenFuture = fetchAllcitizens();
  }
