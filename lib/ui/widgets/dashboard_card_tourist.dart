...
Future<CardStatistics> fetchStatistics() async {
  final response =
      await http.get(Uri.parse('http://127.0.0.1:5000/api/stats/tourists'));
...
class DashboardCardTourist extends StatelessWidget {
  const DashboardCardTourist({
    super.key,
  });
          ...
          return Positioned(
              ...
              child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    color: Color.fromRGBO(221, 237, 234, 1),
                  ),
