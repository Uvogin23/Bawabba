...
Future<List<Tourist>> fetchAllTourists() async {
  final response = await http.get(Uri.parse('${Config.baseUrl}/api/tourists'));
...
class HistoryTable2 extends StatefulWidget {
  const HistoryTable2({Key? key}) : super(key: key);

  @override
  State<HistoryTable2> createState() => _HistoryTable2();
}

class _HistoryTable2 extends State<HistoryTable2> {
  ...
  void initState() {
    ...
    super.initState();
    touristsFuture = fetchAllTourists();
  }
